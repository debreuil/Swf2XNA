...
namespace Box2DX.Dynamics
{
	...
	public class Body : IDisposable
	{
		...
		/// </summary>
        /// <param name="omega">The new linear damping.</param>
        public void SetLinearDamping(float omega)
		{
            _linearDamping = omega;
		}

		/// <summary>
        /// Get the linear damping.
		/// </summary>
        /// <returns>Return the linear damping.</returns>
		...
		/// </summary>
		/// <param name="omega">The new angular damping.</param>
		public void SetAngularDamping(float omega)
		{
			_angularDamping = omega;
		}

		/// <summary>
        /// Get the angular damping.
		/// </summary>
        /// <returns>Return the angular damping.</returns>
