...
namespace DDW.V2D
{
    public class V2DStage : Stage
    {
        ...
        private static V2DStage instance;
        public static V2DStage GetInstance()
        {
            if (instance == null)
            {
                instance = new V2DStage();
            }
            return instance;
        }
        ...
        {
            if (boundsBodies[0] != null) { world.DestroyBody(boundsBodies[0]); }
            if (boundsBodies[1] != null) { world.DestroyBody(boundsBodies[1]); }
            if (boundsBodies[2] != null) { world.DestroyBody(boundsBodies[2]); }
            if (boundsBodies[3] != null) { world.DestroyBody(boundsBodies[3]); }
